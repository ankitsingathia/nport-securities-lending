...
**[Read the report, with interactive charts](https://ankitsingathia.github.io/nport-securities-lending/docs/report.html)** ·
[Dashboard, two pages as PDF](docs/powerbi/securities_lending.pdf) ·
[Working notes](https://ankitsingathia.github.io/nport-securities-lending/docs/readout.html) ·
...
The findings above are written up as a report, with charts you can read by
posting: [**Securities lending exposure in US funds**](https://ankitsingathia.github.io/nport-securities-lending/docs/report.html).
Pick a posting at the top and every figure, chart and table follows it. The
page is generated by `scripts/report.py` straight from the warehouse, so no
...
| Report | `scripts/report.py` queries the warehouse and writes `docs/report.html`, a single file with the charts embedded |
...
python scripts/report.py                 # writes docs/report.html
```
...
docs/        the report, decision log, working notes, Power BI report and its data
